...
<div align=center><img src="./Graph/Train_text_length.jpg" width=70% height=70% alt="图片名称"></div>



<!-- ![训练集文本(Text)长度](./Graph/Train_text_length.jpg "训练集文本(Text)长度") -->
因此对Text文本按照"。"划分，得到句子的长度：
<div align=center><img src="./Graph/Train_sentence_length.jpg" width = 70% height = 70% /></div>
